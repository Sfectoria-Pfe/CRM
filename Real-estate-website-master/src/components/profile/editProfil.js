...
export default function ProfileEdit() {
  ...
  return (
    <div
      style={{
        background: "linear-gradient(to bottom, #d9e3f0, #f0f0f0)",
        minHeight: "100vh",
        padding: "20px",
      }}
    >
      ...
      <MDBContainer>
        <MDBRow className="justify-content-center">
          <MDBCol md="8">
            {" "}
            {/* Ajustez la taille de la colonne selon vos besoins */}
            <div
              style={{
            ...
            >
              <form onSubmit={handleSubmit}>
                ...
                <MDBInput
                  ...
                  label={
                    <>
                      <FaAddressCard /> <strong>Adresse</strong>
                    </>
                  }
                  onChange={handleChange}
                  required
                ...
                <MDBInput
                  ...
                  label={
                    <>
                      <FaPhone /> <strong>Téléphone</strong>
                    </>
                  }
                  onChange={handleChange}
                  required
