      ...
      <Row>
          ...
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Row className="mb-5">
              <Col>
                ...
                <Form.Control placeholder="Nom" value={nom} type="text" name="nom" className="my-2" onChange={editField} autoComplete="nom" required />
                <Form.Control placeholder="Email" value={email} type="email" name="email" className="my-2" onChange={editField} autoComplete="email" required />
                <Form.Control placeholder="Adresse" value={adresse} type="text" name="adresse" className="my-2" autoComplete="adresse" onChange={editField} required />
                <Form.Control placeholder="Client ID" value={clientId} type="text" name="clientId" className="my-2" autoComplete="clientId" onChange={editField} required />
              </Col>
              <Col>
                <Form.Label className="fw-bold">Information entreprise:</Form.Label>
                <Form.Control placeholder="Nom entreprise" value={nom_entreprise} type="text" name="nom_entreprise" className="my-2" onChange={editField} autoComplete="nom_entreprise" required />
                <Form.Control placeholder="Email entreprise" value={email_entreprise} type="email" name="email_entreprise" className="my-2" onChange={editField} autoComplete="email_entreprise" required />
                <Form.Control placeholder="Adresse entreprise" value={adresse_entreprise} type="text" name="adresse_entreprise" className="my-2" autoComplete="adresse_entreprise" onChange={editField} required />
                <Form.Control placeholder="Téléphone entreprise" value={telephone_entreprise} type="text" name="telephone_entreprise" className="my-2" autoComplete="telephone_entreprise" onChange={editField} required />
              </Col>
            </Row>
            {/* Invoice items */}
            ...
            <Row className="mt-4 justify-content-end">
              <Col lg={6}>
                ...
                <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                  ...
                  <span><span className="small">({discountRate || 0}%)</span>{currency}{discountAmount || 0}</span>
                </div>
                <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                  <span className="fw-bold">Tax:</span>
                  <span><span className="small">({taxRate || 0}%)</span>{currency}{taxAmount || 0}</span>
                </div>
                <hr />
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <InvoiceModal showModal={isOpen} closeModal={closeModal} info={{ currentDate, dateOfIssue, invoiceNumber, nom, email, adresse, clientId, nom_entreprise, email_entreprise, adresse_entreprise, telephone_entreprise, notes }} items={items} currency={currency} subTotal={subTotal} taxAmount={taxAmount} discountAmount={discountAmount} total={total} />
            ...
            <Button variant="primary" type="button" className="d-block w-100" onClick={handleAddDevis}>Ajouter devis</Button>
            <ToastContainer />
          </div>
        </Col>
      </Row>
